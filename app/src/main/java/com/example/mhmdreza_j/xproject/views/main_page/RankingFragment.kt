...
class RankingFragment : EventListenerFragment() {
    ...
    private val startGameOnClickListener: View.OnClickListener
    ...
    private fun initViews(view: View) {
        ...
        view.findViewById<View>(R.id.dicesLayout).setOnClickListener(startGameOnClickListener)
        view.findViewById<View>(R.id.marblesLayout).setOnClickListener(startGameOnClickListener)
        view.findViewById<View>(R.id.rabbitsLayout).setOnClickListener(startGameOnClickListener)
        view.findViewById<View>(R.id.birdsLayout).setOnClickListener(startGameOnClickListener)
    ...
    private fun setData(record: RecordResponse) {
        ...
        UIUtils.setProfileImage(profileImageView, record.avatar)
    }

    companion object {
        const val LAYOUT_RESOURCE_ID = R.layout.fragment_ranking
    }
